...
<body>
	...
	<div class="main">
		<img class="image-contact" src='images/bg-07.png'></img>
		<div class="row">
			<div class="col-md-4 ">
                <h2>Ustawienia</h2>
                <br/>
                ...
                <label class="label-checkbox-input" for="newsletter">Chcę otrzymywać powiadomienia o nowościach</label>
                <br/>
                <input type="checkbox" value="print" name="print">
                <label class="label-checkbox-input" for="print">Chcę otrzymywać pdf z podsumowaniem na koniec każdego miesiąca</label>
			</div>
			<div class="col-md-8">
